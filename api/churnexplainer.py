...
# Module  : churnexplainer.py
# Purpose : Defines ExplainedModel and CategoricalEncoder helper classes.
#           ExplainedModel bundles the sklearn pipeline, LIME explainer, and
#           training data into a single serializable object for model serving.
# License : Apache 2.0
# =============================================================================
